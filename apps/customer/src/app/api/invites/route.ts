...
export async function POST(request: NextRequest) {
  ...
  // signed URL can be stored alongside the row in a single INSERT — the
  // event-dispatcher then sees a complete, email-ready row on first sight and
  // doesn't need the signing secret to build the link itself.
